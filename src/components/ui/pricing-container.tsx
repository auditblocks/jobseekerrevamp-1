...
const PricingCard = ({
    ...
    return (
        <motion.div
            ...
            className={`relative w-full bg-white rounded-xl p-6 border-[3px] border-black
            ...
            <div className="mb-4">
                ...
                {plan.isCurrent && (
                    <motion.span
                        ...
                        font-bold rounded-md text-xs border-2 border-black bg-gray-100
                        shadow-[2px_2px_0px_0px_rgba(0,0,0,0.9)] ml-2"
                    >
                        CURRENT
                    </motion.span>
                )}
