...
INSERT INTO public.domains (name, display_name, description, sort_order) VALUES
('technology', 'Technology', 'Software, IT, and tech roles', 1),
('finance', 'Finance', 'Banking, investment, and financial services', 2),
('healthcare', 'Healthcare', 'Medical, pharmaceutical, and health services', 3),
('marketing', 'Marketing', 'Digital marketing, advertising, and PR', 4),
('sales', 'Sales', 'Sales and business development', 5),
('operations', 'Operations', 'Operations and supply chain management', 6),
('hr', 'Human Resources', 'HR and talent acquisition', 7),
('legal', 'Legal', 'Legal and compliance roles', 8),
('education', 'Education', 'Teaching and academic roles', 9),
('other', 'Other', 'Other job categories', 10);
...
CREATE INDEX idx_subdomains_domain_id ON public.subdomains(domain_id);
CREATE INDEX idx_subdomains_is_active ON public.subdomains(is_active);
...
CREATE INDEX idx_subscription_history_plan_id ON public.subscription_history(plan_id);
...
CREATE INDEX idx_recruiters_domain ON public.recruiters(domain);
CREATE INDEX idx_recruiters_subdomain_id ON public.recruiters(subdomain_id);
CREATE INDEX idx_recruiters_tier ON public.recruiters(tier);
CREATE INDEX idx_recruiters_scraped_at ON public.recruiters(scraped_at);
CREATE INDEX idx_recruiters_source_platform ON public.recruiters(source_platform);
